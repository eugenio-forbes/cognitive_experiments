...
if __name__ == '__main__':
    ...
    file_dictionary = {
        'pulses': (pulses_file, pulses_fieldnames),
        'events': (events_file, events_fieldnames),
    ...
    files_exist = checkpoint_exist or pulses_exist or events_exist or timing_exist
