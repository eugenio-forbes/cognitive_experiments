"""
Configurations for Associative Recognition (Elemem) Experiment
...
experiment_name = 'associative_recogntion_elemem' # Folder with code and directories should have the same name
...
n_heartbeats = 50                  # heartbeats to be sent both at the start and the end of the experiment
...
events_fieldnames = [
    'subject', 'session', 'experiment_block', 'experiment_phase', 'trial_index',
    'top_word', 'bottom_word', 'study_answer', 'test_condition', 'study_response',
    'study_time_to_respond', 'test_response', 'test_time_to_respond',
    'log_num', 'log_time']
